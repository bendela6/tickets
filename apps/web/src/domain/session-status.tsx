...
const MAP: Record<SessionStatus, Entry> = {
  starting: { tone: 'gray', icon: <Icon name="circle-half" size="xs" animate="spin" />, label: 'starting' },
  running: { tone: 'blue', icon: <Icon name="circle-half" size="xs" animate="spin" />, label: 'running' },
  idle: { tone: 'green', icon: <Icon name="circle-dot" size="xs" />, label: 'idle' },
  awaiting_input: {
    tone: 'orange',
    variant: 'solid',
    className: 'font-600 animate-pulse',
    icon: <Icon name="diamond" size="2xs" />,
    label: 'awaiting input',
  },
  interrupted: { tone: 'gray', icon: <Icon name="circle-dashed" size="xs" />, label: 'interrupted' },
  exited: { tone: 'secondary', icon: <Icon name="square" size="2xs" />, label: 'exited' },
  failed: { tone: 'danger', icon: <Icon name="circle-x" size="xs" />, label: 'failed' },
  live: { tone: 'blue', icon: <Icon name="dot" size="2xs" />, label: 'Live' },
  disconnected: { tone: 'gray', icon: <Icon name="circle" size="xs" className="opacity-70" />, label: 'Disconnected' },
};
