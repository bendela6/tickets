...
import { cn, Icon, Pill, ScreenState, SegmentedControl, Tabs, toneClasses } from '@tickets/ui';
    ...
    <div className="flex h-full min-h-0 flex-col px-4 pt-4 md:px-7 md:pt-5.5">
      ...
      <div className="mb-3 flex shrink-0 items-center gap-1.5 border-b border-hairline">
        ...
        <button
          ...
          className="cursor-pointer px-2.5 py-2 font-sans text-ui text-ink-3 hover:text-ink"
        ...
        <Menu>
          <MenuTrigger asChild>
            <button type="button" className="cursor-pointer py-2 font-sans text-meta text-ink-2">
              Group:{' '}
      ...
      <div className="mb-2 shrink-0 font-mono text-meta text-ink-3">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-auto rounded-t-[12px] border border-hairline bg-raised">
        ...
        >
          ...
          <span className="px-2 font-sans text-label font-medium text-ink-2 uppercase">Title</span>
          {visibleColumns.map((id) => (
            <span key={id} className="px-2 font-sans text-label font-medium text-ink-2 uppercase">
            ...
            <div key={group.key} className="min-w-170">
              ...
              {group.rows.map((row) => (
                <div
                  ...
                  className={cn(
                    'grid shrink-0 cursor-pointer items-center border-b border-hairline px-1 hover:bg-app',
