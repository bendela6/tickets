...
function Block({ block, onRespond }: { block: StreamBlock; onRespond?: RespondFn }) {
  switch (block.kind) {
    ...
    case 'error':
      return (
        <div className="rounded-8 border-1 border-red-9 bg-red-3 px-12 py-8 font-sans text-12/17 text-red-9">
          {block.message}
        </div>
      );
    case 'permission':
...
function ApprovalCard({
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-12 border-2 border-orange-9 bg-orange-3 shadow-lg',
    ...
    >
      <div className="flex items-center gap-8 px-14 py-10">
        ...
        <Pill
          ...
          variant="outline"
          label={toolName}
          className="h-auto rounded-6 border-gray-6 bg-surface-raised px-6 py-0 font-mono text-11"
        />
        ...
        <div className="flex flex-col gap-8 px-14 py-10">
          {denying ? (
            <textarea
              ...
              className="resize-y rounded-8 border-1 border-gray-7 bg-surface-raised px-10 py-6 font-sans text-12/17 text-gray-12 placeholder:text-gray-9 focus:border-indigo-9 focus:outline-none focus:ring-3 focus:ring-indigo-3"
            />
          ) : null}
  ...
  return (
    <div className="self-start">
      <button
        ...
        className="flex items-center gap-8 rounded-8 border-1 border-dashed border-gray-7 px-10 py-4 font-sans text-12/17 italic text-gray-9 hover:text-gray-11"
      >
...
function ToolCard({ name, input, result }: { name: string; input: unknown; result?: ToolResult }) {
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-8 border-1 bg-surface-raised',
    ...
    >
      ...
      >
        ...
        {diff ? (
          <>
            <span className="rounded-4 bg-green-3 px-6 font-mono text-10 text-green-9">
              +{diff.added}
            </span>
            <span className="rounded-4 bg-red-3 px-6 font-mono text-10 text-red-9">
              −{diff.removed}
            </span>
          </>
        ) : null}
  ...
  return (
    <div className="my-2 flex flex-col gap-8 border-l-2 border-gray-7 pl-12">
      <div className="flex items-center gap-8">
        <span className="inline-flex size-16 shrink-0 items-center justify-center rounded-4 bg-indigo-3 font-mono text-9 font-600 text-indigo-9">
        ...
        <Pill
          ...
          variant="outline"
          label="subagent"
          className="h-auto rounded-4 px-6 py-0 font-mono text-9 uppercase tracking-wide"
        />
