...
export function AgentSessionScreen({ sessionId }: { sessionId: number }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-10 border-b-1 border-gray-6 px-24 py-12">
        <button
          type="button"
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto flex max-w-3xl flex-col gap-16 px-24 py-24">
          {rendered.length === 0 ? (
            <p className="py-40 text-center font-sans text-12/17 text-gray-9">
      ...
      <div className="border-t-1 border-gray-6 px-24 py-12">
        <PromptComposer
          value={draft}
          onChange={setDraft}
          onSend={send}
