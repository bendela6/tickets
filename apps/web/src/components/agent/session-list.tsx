  ...
  return (
    <>
      <Link
        ...
        className="group flex items-center gap-8 rounded-lg px-8 py-6 hover:bg-surface-inset"
      ...
      >
        ...
        {session.itemId != null ? (
          <span className="shrink-0 rounded-sm border-1 border-gray-6 px-4 font-mono text-10 text-indigo-9">
            →#{session.itemId}
          </span>
        ) : null}
