...
// Link-editing popover (RichTextEditor.dc.html §07): edit / remove icon
// buttons — same hand-copied-lucide convention as the rest of this file.
...
export function IconTrash2({ size }: IconProps) {
  return (
    <Svg size={size}>
      <path d="M10 11v6" />
      <path d="M14 11v6" />
