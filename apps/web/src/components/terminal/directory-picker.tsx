...
export function DirectoryPicker({
  ...
  return (
    <div className="overflow-hidden rounded-12 border-1 border-gray-7 bg-gray-1">
      <div className="flex h-32 items-center gap-8 border-b-1 border-gray-6 bg-surface-inset px-10">
        <span aria-hidden className="size-12 shrink-0 rounded-4 border-1 border-yellow-8" />
        {value ? (
