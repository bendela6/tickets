    ...
    <div className="pointer-events-none absolute left-0 top-0 z-0">
      {model._groupBounds.map((b) => {
        ...
        const cls = cn(
          ...
          'rounded-12 border-1 border-dashed border-(--zone-border) bg-(--zone-bg)',
          ...
          'after:rounded-br-6 after:border-b-2 after:border-r-2 after:border-(--zone-handle)',
          'after:opacity-0 after:transition-opacity after:duration-120 hover:after:opacity-100',
          {
            'rounded-12 border-solid': subgroup,
