...
export const rowClass =
  'flex w-full cursor-pointer items-center gap-2 rounded-md border-1 border-transparent px-2 py-2 text-left text-12 hover:border-gray-7 hover:bg-surface-inset';
