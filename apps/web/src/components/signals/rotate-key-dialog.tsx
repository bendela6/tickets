      ...
      <DialogContent>
        {rotated === null ? (
          ...
          <>
            ...
            <p className="mt-1.5 font-sans text-12/17 text-red-9">
              The old DSN no longer works. Update every SDK pointed at {app.slug} with the new DSN below.
            </p>
            <div className="mt-4">
              <div className="mb-1.5 font-mono text-11/13 tracking-wider font-500 tracking-wide text-gray-9">NEW DSN</div>
