import { agentSchema, coreSchema, structureSchema, terminalSchema } from './schemas';
...
export const statusKindEnum = structureSchema.enum('status_kind', [
  'todo',
  'active',
  'blocked',
  'done',
...
export const fieldTypeEnum = structureSchema.enum('field_type', [
  'string',
  'number',
  'boolean',
  'date',
