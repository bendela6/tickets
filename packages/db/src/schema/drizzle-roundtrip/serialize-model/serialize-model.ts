// A COPY of the eer app's engine/model/serialize-model/serialize-model.ts, not
// a move — see drizzle-roundtrip/types/types.ts's header for why. Needed here
// only as a transitive dependency of import-drizzle.ts (which round-trips the
// existing model through this to recover what a fresh SQL description can't).
//
