// A COPY of the eer app's engine/model/load-model/load-model.ts, not a move —
// see drizzle-roundtrip/types/types.ts's header for why. Needed here only as
// a transitive dependency of import-drizzle.ts (which merges a freshly
// introspected drizzle schema into a Model).
//
