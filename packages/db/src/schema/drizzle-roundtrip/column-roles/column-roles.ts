// A COPY of the eer app's engine/model/column-roles/column-roles.ts, not a
// move — see drizzle-roundtrip/types/types.ts's header for why. Needed here
// only as a transitive dependency of load-model.ts.
//
