      ...
      {specRows('radius', RADII).map((radius) => (
        <SpecRow key={radius.name} name={radius.name} value={radius.value} note={RADIUS_JOBS[radius.name]}>
          <div className="flex items-center gap-4">
            ...
            />
            <span
              className={`flex h-16 flex-1 items-center justify-center border-1 border-gray-6 bg-surface-raised font-mono text-12/17 text-gray-9 ${RADIUS_CLASS[radius.name]}`}
            >
              {radius.value}
            </span>
          </div>
    ...
    <Sheet>
      <div className="flex flex-wrap items-start gap-6">
        <div className="flex flex-col gap-2">
          ...
          <span className="inline-flex h-5.5 items-center rounded-sm bg-indigo-3 px-2.25 font-sans text-12/17 font-500 text-indigo-9">
            blocked
          </span>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <span className="inline-flex h-7 items-center rounded-md border-1 border-gray-6 bg-surface-raised px-3 font-sans text-13/19 text-gray-12">
            Assign
          </span>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex w-56 flex-col gap-1 rounded-lg border-1 border-gray-6 bg-surface-raised p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex w-64 flex-col gap-2 rounded-xl border-1 border-gray-6 bg-surface-raised p-4">
