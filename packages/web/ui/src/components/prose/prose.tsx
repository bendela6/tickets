...
const H1 = (p: El<'h1'>) => (
  <h1 {...p} className="mt-5 mb-2 font-semibold text-15 text-gray-12 first:mt-0" />
);
const H2 = (p: El<'h2'>) => (
  <h2 {...p} className="mt-5 mb-2 font-semibold text-14 text-gray-12 first:mt-0" />
);
const H3 = (p: El<'h3'>) => (
  <h3 {...p} className="mt-4 mb-1 font-semibold text-13 text-gray-12 first:mt-0" />
);
const P = (p: El<'p'>) => <p {...p} className="my-2 text-13/19 text-gray-11 first:mt-0 last:mb-0" />;
const Ul = (p: El<'ul'>) => <ul {...p} className="my-2 ml-4 list-disc space-y-1" />;
const Ol = (p: El<'ol'>) => <ol {...p} className="my-2 ml-4 list-decimal space-y-1" />;
...
const Code = (p: El<'code'>) => (
  <code
    {...p}
    className="rounded-sm bg-surface-inset px-1 py-0.5 font-mono text-12 text-gray-12"
  />
);
...
const Pre = (p: El<'pre'>) => (
  <pre
    {...p}
    className="my-3 overflow-x-auto rounded-md bg-surface-inset p-3 font-mono text-12/17 text-gray-12"
  />
);
const Blockquote = (p: El<'blockquote'>) => (
  <blockquote {...p} className="my-3 border-gray-6 border-l-2 pl-3 text-gray-11 italic" />
);
const Hr = (p: El<'hr'>) => <hr {...p} className="my-4 border-gray-6" />;
...
const Th = (p: El<'th'>) => (
  <th
    {...p}
    className="border-gray-6 border-b-1 px-2 py-1 text-left font-semibold text-gray-12"
  />
);
const Td = (p: El<'td'>) => (
  <td {...p} className="border-gray-6 border-b-1 px-2 py-1 align-top text-gray-11" />
);
const Img = (p: El<'img'>) => <img {...p} alt={p.alt ?? ''} className="my-3 max-w-full rounded-sm" />;
