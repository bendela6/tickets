  ...
  return (
    <div className="flex items-center gap-8">
      ...
      <input
        ...
        className="h-28 w-40 shrink-0 rounded-md border-1 border-gray-6"
      />
      <span aria-hidden className="mr-4 size-16 shrink-0 rounded-sm border-1 border-gray-6" style={{ background: derived }} />
