---
name: syncing-design
description: Use when pushing the component library or tokens to the Codex.ai/design project, pulling design changes into the repo, or when asked to sync design and code — including when DesignSync authorization fails or the target design project can't be found.
---
